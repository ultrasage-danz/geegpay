...
const ThemeSwitcher = () => {
  ...
  return (
    <button
      ...
      className="rounded-lg -ml-2 w-7.5 rotate-0   h-72 bg-white-800 text-white"
    >
      {darkMode ? 
      <svg class="dark" className='ml-[8.5px] bg-see rounded-full ' width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <svg class="dark:block"  width="16" height="16" xmlns="http://www.w3.org/2000/svg">
